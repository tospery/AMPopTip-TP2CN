Pod::Spec.new do |s|
  s.name          = "AMPopTip-TP2CN"
  s.version       = "4.5.3-tp2cn-v1"
  ...
  s.description   = <<-DESC
                    ...
                    DESC
  s.homepage      = "https://github.com/tospery/AMPopTip-TP2CN"
  s.license       = { :type => 'MIT', :file => 'LICENSE' }
  s.author        = { "YangJianxiang" => "tospery@gmail.com" }
  s.source        = { :git => "https://github.com/tospery/AMPopTip-TP2CN.git", :tag => s.version }
  s.platform      = :ios, '10.0'
  s.swift_version = '5.0'
